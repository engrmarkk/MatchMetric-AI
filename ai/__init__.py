...
class AnalysisResult(BaseModel):
    ...
    sentence_to_improve: str = Field(description="The original sentence found in the resume")
    recommended_improvement: str = Field(description="The improved version of that sentence")
